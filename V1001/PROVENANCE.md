...
- 初始日期：2026-09-18。
- 来源版本：`/home/xueshuailin/CCC_Phe/V1000`，完整复制为独立快照；V999 和 V1000 未修改。
- 直接复用 V1000 structured generator truth、ST factorization、Hungarian evaluation、bulk projection、NNLS audit 和 Cox。
- 新增部分仅为 cell-level neighborhood representation、ordered pair CCC/opportunity aggregation、机制诊断与版本对照。
- Primary 固定 radius=1.6、Gaussian sigma=0.8、每个 spatial coordinate 12 cells，未做 sweep，未使用 truth 或 test 选参。
